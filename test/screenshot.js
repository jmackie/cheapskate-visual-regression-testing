...
async function main() {
  ...
  await page.screenshot({ path: "./latest-screenshots/Hello_1200.png" });
  await page.setViewport(Object.assign(page.viewport(), { width: 700 }));
  await page.screenshot({ path: "./latest-screenshots/Hello_700.png" });
  await page.setViewport(Object.assign(page.viewport(), { width: 400 }));
  await page.screenshot({ path: "./latest-screenshots/Hello_400.png" });
